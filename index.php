...
<section class="py-16 md:py-24 -mt-8">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex flex-col text-center lg:text-left">
            <div class="order-1">
                <span
                    class="inline-block px-4 py-1 bg-brand-red text-white text-sm font-semibold rounded-full uppercase tracking-wider">
                    Hot & Fresh
                </span>
            </div>
            ...
            <div class="flex items-center justify-center order-2 lg:hidden mt-6">
                ...
                $image_style = '';
                if ($style == 'shadow') {
                    $image_classes .= ' rounded-3xl shadow-2xl transform';
                } elseif ($style == 'card') {
                    ...
                    $image_classes .= ' rounded-3xl transform';
                } else {
                    $image_classes .= ' rounded-3xl';
                }
                ?>
                <img src="<?php echo e(BASE_URL . ($settings['hero_image_url'] ?? 'https://placehold.co/600x600/FFB000/000000?text=Pizza+Mania')); ?>"
                    alt="Delicious Pizza" class="<?php echo $image_classes; ?>" style="<?php echo $image_style; ?>"
            ...
            <div class="order-5 mt-10">
                <a href="<?php echo BASE_URL; ?>/menu"
                    class="px-10 py-4 bg-brand-red text-white text-lg font-bold rounded-lg shadow-lg hover:bg-red-700 transition-colors transform hover:scale-105">
                    Order Now
                </a>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-<?php echo count($homepage_categories); ?> gap-6">
                <?php foreach ($homepage_categories as $category): ?>
                    <a href="<?php echo BASE_URL; ?>/menu#category-<?php echo e($category['id']); ?>"
                        class="block bg-white p-6 rounded-2xl shadow-lg transform transition-all hover:shadow-xl hover:-translate-y-1">
...
<?php if (!empty($settings['offer_is_active']) && $settings['offer_is_active'] == '1'): ?>
    <section class="py-16">
        <div
            class="bg-red-50 border-l-8 border-brand-red rounded-2xl shadow-lg p-8 md:p-12 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div class="flex-shrink-0">
                <a href="<?php echo BASE_URL; ?>/menu"
                    class="px-8 py-4 bg-brand-red text-white text-lg font-bold rounded-lg shadow-lg hover:bg-red-700 transition-colors">
                    Order Now
                </a>
            </div>
        </div>
                            ...
                            <div class="flex justify-between items-center mt-4">
                                <p class="text-2xl font-bold text-gray-900">
                                    <?php if ($item['has_discount']): ?>
                                        ...
                                        <span
                                            class="text-sm font-normal text-gray-500 line-through ml-1"><?php echo number_format($item['original_price'], 0); ?></span>
                                    <?php else: ?>
                                        <?php echo number_format($item['price'], 0); ?>
                                    <?php endif; ?>
    ...
    <section class="py-16">
        ...
        <div class="text-center mt-12">
            <a href="<?php echo BASE_URL; ?>/reviews"
                class="px-8 py-3 bg-white text-brand-red font-semibold rounded-lg shadow-md hover:bg-gray-50 border border-gray-200 transition-colors">
                See All Reviews
            </a>
        </div>
    </section>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 md:p-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="text-center">
                ...
                <p class="mt-1 text-gray-600">Use the "Track Order" page with your Order ID to see its status in
                    real-time.</p>
            </div>
        </div>
    </div>
