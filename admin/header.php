...
<body class="bg-slate-100 font-sans antialiased">
    <div class="relative min-h-screen lg:flex">
        ...
        <!-- Sidebar -->
        <aside id="sidebar" class="bg-gray-900 text-white w-64 fixed inset-y-0 left-0 z-50 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out flex flex-col h-screen shadow-lg">
            ...
            <nav class="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
                ...
                <?php if (hasAdminAccess()): ?>
                    ...
                    <a href="ledger.php" class="flex items-center space-x-3 px-3 py-2 rounded-lg nav-link-default">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M21 12a2.25 2.25 0 01-2.25 2.25H15a3 3 0 11-6 0H5.25A2.25 2.25 0 013 12m18 0v-2.25A2.25 2.25 0 0018.75 7.5H5.25A2.25 2.25 0 003 9.75v2.25m18 0A2.25 2.25 0 0118.75 14.25H5.25A2.25 2.25 0 013 12m18 0v-2.25" /></svg>
