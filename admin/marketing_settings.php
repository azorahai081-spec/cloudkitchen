 ...
 * PizzaMania: Cloud Kitchen Marketing & API Key Manager
...
<form action="marketing_settings.php" method="POST" class="space-y-12">
    ...
    <div class="bg-white p-8 rounded-2xl shadow-lg">
        ...
        <div class="space-y-6">
            <div>
                ...
                <input type="text" id="gtm_id" name="gtm_id" value="<?php echo e($settings['gtm_id'] ?? ''); ?>"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" id="fb_pixel_id" name="fb_pixel_id"
                    value="<?php echo e($settings['fb_pixel_id'] ?? ''); ?>" placeholder="1234567890"
            ...
            <div>
                ...
                <input type="password" id="fb_capi_token" name="fb_capi_token"
                    value="<?php echo e($settings['fb_capi_token'] ?? ''); ?>" placeholder="EAA..."
                    class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500">
                <p class="text-xs text-gray-500 mt-1">Your server-to-server Conversions API token.</p>
            </div>

            <div class="md:col-span-2">
                <label for="fb_capi_test_code" class="block text-sm font-medium text-gray-700">CAPI Test Event Code
                    (Optional)</label>
                <input type="text" id="fb_capi_test_code" name="fb_capi_test_code"
                    value="<?php echo e($settings['fb_capi_test_code'] ?? ''); ?>" placeholder="TEST12345"
                    class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500">
    ...
    <div class="flex justify-end">
        <button type="submit"
            class="px-8 py-3 bg-orange-600 text-white font-medium rounded-lg shadow-md hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors">
