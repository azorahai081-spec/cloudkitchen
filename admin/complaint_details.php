 ...
 * PizzaMania: Cloud Kitchen Complaint Details Page
...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
    ...
    <a href="manage_complaints.php"
        class="mt-4 sm:mt-0 px-5 py-2 bg-gray-200 text-gray-700 font-medium rounded-lg shadow-md hover:bg-gray-300">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="mt-1 p-4 w-full bg-gray-50 border border-gray-200 rounded-lg">
                        <p class="text-base text-gray-800" style="white-space: pre-wrap;">
                            <?php echo e($complaint['complaint_text']); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div>
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <p>
                            <a href="order_details.php?id=<?php echo e($complaint['order_id']); ?>"
                                class="text-lg font-medium text-orange-600 hover:text-orange-800">
            ...
            <div>
                ...
                <form action="complaint_details.php?id=<?php echo e($complaint_id); ?>" method="POST" class="space-y-4">
                    ...
                    <button type="submit" name="update_status"
                        class="w-full py-3 px-4 bg-green-600 text-white font-medium rounded-lg shadow-md hover:bg-green-700">
                        Update Status
                    </button>
                </form>
            </div>
