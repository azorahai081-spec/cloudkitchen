 ...
 * Version 4.4 - (FIXED) Syntax checks and integer display
 */
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-5 hover:bg-gray-50 transition-colors flex items-start gap-5">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex justify-between items-start">
                            ...
                            <span class="font-bold text-gray-900 whitespace-nowrap"><?php echo number_format($item['total_price'], 0); ?></span>
                        </div>
                        <div class="mt-1.5 flex flex-wrap gap-2">
                            <?php if (!empty($item['opts'])): ?>
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-medium bg-orange-50 text-orange-700 border border-orange-100">
                                    <?php echo e($opt['option_name']); ?> (+<?php echo number_format($opt['option_price'], 0); ?>)
                                </span>
                                <?php endforeach; ?>
                            <?php else: ?>
            ...
            <div class="bg-gray-50/80 p-6 border-t border-gray-200">
                <div class="space-y-3 text-sm text-gray-600 max-w-sm ml-auto">
                    <div class="flex justify-between"><span>Subtotal</span><span class="font-medium text-gray-900"><?php echo number_format($order['subtotal'], 0); ?></span></div>
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium text-gray-900"><?php echo number_format($order['delivery_fee'], 0); ?></span>
                    </div>
                ...
                <div class="mt-6 pt-4 border-t border-gray-200 flex justify-between items-center">
                    ...
                    <div class="font-extrabold text-3xl text-emerald-600 flex items-baseline gap-1">
                        <?php echo number_format($order['total_amount'], 0); ?> <span class="text-sm font-bold text-emerald-600/60">BDT</span>
                    </div>
                </div>
            </div>
        </div>
