 ...
 * PizzaMania: Cloud Kitchen Order History Page
...
<div class="bg-white p-4 rounded-2xl shadow-lg mb-8">
    <form action="manage_orders.php" method="GET" class="flex flex-col sm:flex-row gap-4">
        ...
        <select name="status"
            class="px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <?php else: ?>
                    <?php foreach ($orders as $order): ?>
                        <tr>
                            <td class="px-6 py-4">
                                <div class="text-sm font-bold text-gray-900">#PM-<?php echo e($order['id']); ?></div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-700">
                                    <?php echo e(date('d M, h:i A', strtotime($order['order_time']))); ?></div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <form action="manage_orders.php?<?php echo http_build_query($_GET); ?>" method="POST"
                                    class="flex items-center">
                                    <!-- (NEW) CSRF Token -->
                                    <input type="hidden" name="csrf_token" value="<?php echo e(get_csrf_token()); ?>">
                                    <input type="hidden" name="order_id" value="<?php echo e($order['id']); ?>">
                                    <select name="new_status" class="text-xs p-1 border border-gray-300 rounded-md"
                            ...
                            <td class="px-6 py-4 text-right text-sm font-medium space-x-2">
                                ...
                                <a href="print_receipt.php?id=<?php echo e($order['id']); ?>" target="_blank"
                                    class="text-blue-600 hover:text-blue-900">Print</a>
